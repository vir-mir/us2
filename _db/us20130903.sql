...
INSERT INTO `auth_user` (`id`, `password`, `last_login`, `is_superuser`, `username`, `first_name`, `last_name`, `email`, `is_staff`, `is_active`, `date_joined`) VALUES 
  (1,'pbkdf2_sha256$10000$2Hy6BvdY9hOc$kS5MeM5MSmN2ZMtYQoapZHRqKFmGwzOexgmCoSVHnWM=','2013-09-02 07:04:48',1,'admin','','','info@vir-mir.ru',1,1,'2013-08-30 05:44:30');
COMMIT;
...
#
# Data for the `user_duties` table  (LIMIT 0,500)
#

INSERT INTO `user_duties` (`id`, `parent_id`, `name`, `date`, `lft`, `rght`, `tree_id`, `level`) VALUES 
  (1,NULL,'werwer','2013-09-02',1,4,1,0),
  (2,NULL,'1Под уровень','2013-09-02',1,2,2,0),
  (3,1,'под wer','2013-09-02',2,3,1,1);
COMMIT;
