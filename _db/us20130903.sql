...
INSERT INTO `site_user_duties` (`id`, `parent_id`, `name`, `date`, `lft`, `rght`, `tree_id`, `level`) VALUES 
  (1,NULL,'фыв','2013-09-03',1,40,1,0),
  (2,1,'Под должность','2013-09-03',2,25,1,1),
  (3,2,'еще под должность','2013-09-03',3,8,1,2),
  (4,2,'Еще под должность','2013-09-03',9,14,1,2),
  (5,1,'Под должность 1','2013-09-03',26,31,1,1),
  (6,5,'под должность23','2013-09-03',27,30,1,2),
  (7,2,'123','2013-09-03',15,20,1,2),
  (8,2,'123-1','2013-09-03',21,24,1,2),
  (9,8,'12','2013-09-03',22,23,1,3),
  (10,7,'3455укацууафыафыв','2013-09-03',16,19,1,3),
  (11,10,'йцуйцуйцуйц','2013-09-03',17,18,1,4),
  (12,3,'лялял','2013-09-03',4,5,1,3),
  (13,3,'тополя','2013-09-03',6,7,1,3),
  (14,4,'не_яяя','2013-09-03',10,13,1,3),
  (15,14,'ываываа','2013-09-03',11,12,1,4),
  (16,6,'sdfsdf','2013-09-03',28,29,1,3),
  (17,1,'Вротая верхняяфыв','2013-09-03',32,35,1,1),
  (18,17,'123','2013-09-03',33,34,1,2),
  (19,1,'ввв','2013-09-03',36,37,1,1),
  (20,1,'фывва','2013-09-03',38,39,1,1);
COMMIT;
...
INSERT INTO `site_user_dateduties` (`id`, `date`, `date_expire`, `staff_id`, `duty_id`) VALUES 
  (1,'2013-09-02','2013-09-03',3,5),
  (2,'2013-09-03','2013-09-03',3,5),
  (3,'2013-09-03',NULL,2,5);
COMMIT;
