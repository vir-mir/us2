...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DateDuties.duty'
        db.add_column(u'site_user_dateduties', 'duty',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['site_user.Duties']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DateDuties.duty'
        db.delete_column(u'site_user_dateduties', 'duty_id')
    ...
    models = {
        ...
        u'site_user.dateduties': {
            ...
            'duty': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['site_user.Duties']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
