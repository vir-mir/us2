...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'task_task', 'status_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['task.Status'], null=True))

        # Changing field 'Task.checked'
        db.alter_column(u'task_task', 'checked_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['site_user.Staff'], null=True))

    def backwards(self, orm):

        # Changing field 'Task.status'
        db.alter_column(u'task_task', 'status_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['task.Status']))

        # Changing field 'Task.checked'
        db.alter_column(u'task_task', 'checked_id', self.gf('django.db.models.fields.related.ForeignKey')(default=3, to=orm['site_user.Staff']))
